...
const EXAMPLES = [
  ...
  { label: "Online Education", interests: "Online education", niche: "EdTech", audience: "College students", goals: "Validate an idea" },
  { label: "E-commerce Tools", interests: "E-commerce automation", niche: "Shopify apps", audience: "Small business owners", goals: "Generate passive income" },
];

const STEPS = [
  { icon: Zap, label: "AI Analysis", desc: "Analyzes market trends" },
  { icon: Target, label: "Strategy", desc: "Builds business model" },
  { icon: TrendingUp, label: "Launch Assets", desc: "Creates landing page" },
];

const INPUT_FIELDS = [
  { key: "interests", label: "Your interests / skills", icon: Zap, placeholder: "e.g. fitness coaching, AI tools, online education", required: true, color: "#6366f1" },
  { key: "niche_preferences", label: "Niche preferences", icon: Target, placeholder: "e.g. B2B SaaS, digital downloads, subscription", required: false, color: "#8b5cf6" },
  { key: "target_audience", label: "Target audience", icon: Users, placeholder: "e.g. solo founders, remote workers, students", required: false, color: "#06b6d4" },
  { key: "goals", label: "Business goals", icon: TrendingUp, placeholder: "e.g. passive income, validate idea, build audience", required: false, color: "#10b981" },
] as const;
    ...
    <div className="anim-fade-in" style={{ maxWidth: 760, margin: "0 auto" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: 36 }}>
        ...
        <p style={{ fontSize: 15, color: "#64748b", margin: 0, lineHeight: 1.6 }}>
          Describe what you want to build. AI generates a complete strategy, landing page, and launch plan in seconds.
        </p>
      </div>
