            ...
            if act == "extract":
                ...
                page_artifacts = await page.evaluate(
                    ...
                    () => {
                      ...
                      const collectCards = () =>
                        Array.from(document.querySelectorAll("section, article, [class*='card'], [class*='pricing'], [class*='plan'], [class*='feature']"))
                          .map((node) => clean(node.innerText || node.textContent || ""))
                      ...
                      return {
                        ...
                        meta_description: clean(meta("description") || meta("og:description")),
                ...
                data = {
                    ...
                    "meta_description": page_artifacts.get("meta_description") or "",
                    "canonical_url": page_artifacts.get("canonical_url") or page.url,
                    "headings": page_artifacts.get("headings") or [],
                    "lists": page_artifacts.get("lists") or [],
                    "links": page_artifacts.get("links") or [],
                    "cards": page_artifacts.get("cards") or [],
                    "json_ld": page_artifacts.get("json_ld") or [],
