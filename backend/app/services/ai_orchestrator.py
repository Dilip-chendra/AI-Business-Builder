...
class ProviderChoice(str, Enum):
    ...
    FEATHERLESS = "featherless"  # Deprecated; retained only for backwards-compatible API input.
...
class SmartAIOrchestrator:
    ...
    ) -> list[Literal["groq", "ollama", "huggingface"]]:
    ...
    async def _execute_with_provider(
        self,
        prompt: str,
        provider: Literal["groq", "ollama", "huggingface"],
        *,
        prefer_json: bool,
        task_type: str | None,
    ) -> str:
    ...
    async def generate_text_with_retry(
        ...
        *,
        ...
        if prefer_provider != ProviderChoice.AUTO:
            if prefer_provider == ProviderChoice.FEATHERLESS:
                raise AIProviderError("Featherless has been disabled for this project. Use Groq, Ollama, or HuggingFace.")
