...
class ProjectSyncService:
    ...
    def _theme_css(self) -> str:
        return (
            ...
            ".abb-hero { padding: 48px 0 20px; background: radial-gradient(circle at top, rgba(99,102,241,0.35), transparent 52%); }\n"
            ...
            ".abb-primary { border: none; border-radius: 999px; background: linear-gradient(135deg, #6366f1, #8b5cf6); color: white; padding: 12px 18px; font-weight: 800; cursor: pointer; }\n"
