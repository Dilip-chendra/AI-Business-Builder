...
const offerLines = ["No more waiting days for repairs\u2014we'll have a pro at your door in hours", "HomeFix Pro connects you with vetted, licensed contractors for emergency home repairs with transparent pricing and 100% satisfaction guarantee."];
const benefitLines = ["Same-day service for urgent repairs", "Licensed and background-checked professionals", "Transparent pricing with no hidden fees", "100% satisfaction guarantee"];

const leadCapture = {"headline": "Need urgent repairs?", "description": "Tell us about your issue and we'll dispatch a pro immediately.", "fields": ["Name", "Phone", "Service needed"], "cta": "Request Emergency Service"};
