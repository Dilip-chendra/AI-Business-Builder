...
const offerLines = ["One trusted home services team for fast response, clear communication, and quality workmanship when your home needs attention.", "Expert Home Services helps homeowners handle urgent repairs and scheduled maintenance with reliable technicians across HVAC, plumbing, electrical, and roofing needs."];
const benefitLines = ["Urgent and scheduled repair support from one trusted team.", "Licensed technicians for HVAC, plumbing, electrical, and roofing work.", "Clear communication, fast arrival windows, and workmanship you can trust."];
